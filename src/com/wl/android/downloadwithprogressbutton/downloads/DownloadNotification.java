...
class DownloadNotification {
	...
	private void updateActiveNotification(Collection<DownloadInfo> downloads) {
        ...
        for (NotificationItem item : mNotifications.values()) {
            ...
            n.contentIntent = PendingIntent.getBroadcast(mContext, 0, intent, Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK);
//            n.setLatestEventInfo(mContext, title, "下载中…",PendingIntent.getBroadcast(mContext, 0, intent, Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK));
